...
// Small SMTP client used by approval, correction, and rejection email automation.
// It connects to the configured mail server, upgrades to TLS, authenticates, then sends HTML email.
final class SmtpClient {
    ...
    // Return true only after the SMTP server accepts the complete message.
