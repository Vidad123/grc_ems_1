...
(function () {
  ...
  async function load(module) {
    ...
    try {
      ...
      const billingTabs = module === "assessments" ? `<nav class="billing-tabs" aria-label="Assessment and receipt views"><button type="button" class="active" data-billing-tab="assessments"><span aria-hidden="true">₱</span> Assessment &amp; Billing</button><button type="button" data-billing-tab="receipts"><span aria-hidden="true">▤</span> Receipt Verification</button></nav>` : "";
