 ...
 * The page body defines a role and module. This file builds that role's menu;
 * backend RBAC still performs the final permission check for every API request.
 */
const portalKey = document.body.dataset.portalRole;
const moduleKey = document.body.dataset.module;
// The menu definition keeps each role limited to its intended pages.
const portalConfig = {
  admin: {
  ...
  teacher: {
    ...
    menus: [
      ...
      ["profile", "My Profile", "profile.html", "♙"],
      ["teacher-sections", "My Sections", "sections.html", "S"],
      ["helpdesk", "Helpdesk", "helpdesk.html", "?"],
    ],
  },
  student: {
...
// Inline SVG paths prevent a dependency on an external icon library.
const iconPaths = {
  ...
  payments: "M4 7h16v12H4zM4 10h16M8 15h3",
  "teacher-sections": "M3 6h18M3 12h18M3 18h18M7 3v18",
};
